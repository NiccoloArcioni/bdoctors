            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="performance" class="col-md-4 col-form-label text-md-right">{{ __('Prestazioni') }}</label>

                            <div class="col-md-6">
                                <input id="performance" type="text" class="form-control @error('performance') is-invalid @enderror" name="performance" value="{{ old('performance') }}" required autocomplete="performance" autofocus>
